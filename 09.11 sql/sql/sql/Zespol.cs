...
namespace sql
{
    ...
    public class Zespol:ICloneable,IZapisywalna
    {
        ...
        public Zasoby zasobyZespolu { get; set; }
        ...
        public KierownikZespolu kierownik { get; set; } //relacja 1:1
        public List<CzlonekZespolu> Czlonkowie { get; set; } //relacja 1 : n
